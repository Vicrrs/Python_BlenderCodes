...
def move_plate(obj_plate):
    ...
    mid_x= (vec_pos_temp[0])/2
    mid_z= (vec_pos_temp[1])/2
...
if __name__=="__main__":
    ...
    for i in range(5000):
        ...
        render_image(Path(f'D:/CILIA/blender/images_mercosul_final/images/{letras_placa}'))
        
        path_txt = f'D:/CILIA/blender/images_mercosul_final/ann/{letras_placa}.txt'
        save_image_points = True 
        path_save_image_points = f"D:/CILIA/blender/images/{letras_placa}.png"
