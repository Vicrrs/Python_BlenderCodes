...
def arrange_on_plate(s):
    ...
    x_start = -((len(s) - 1) * char_width) / 2 - 0.01  # Ajuste o valor -0.1 para mover mais para a esquerda
...
placa = arrange_on_plate("ABC-1234")
if placa:
    print("Placa criada e configurada com sucesso.")