...
if __name__=="__main__":
    for i in range(5):
        ...
        #save_coco_annotations_to_json(f'/media/vicrrs/Novo volume/CILIA/placas/Placa_antigas/images_plates/ann/{letras_placa}_coco.json', annotations)
        
        pos_camera = move_plate(plate)
        render_image(Path(f'/home/vicrrs/CILIA/placas/placa_antiga/images_plates/{letras_placa}'))
        
        image_path = f'/home/vicrrs/CILIA/placas/placa_antiga/images_plates/{letras_placa}.png'
        assign_colors_save_image(obj_all, image_path)
        
        path_txt = f'/home/vicrrs/CILIA/placas/placa_antiga/images_plates/ann/{letras_placa}.txt'
        save_image_points = True 
        path_save_image_points = f"/home/vicrrs/CILIA/placas/placa_antiga/images_plates/img/{letras_placa}.png"
