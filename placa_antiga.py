...
#        pos_camera = move_plate(plate)
    render_image(Path(f'/home/vicrrs/Documentos/CILIA/codes/OCR/Pytesseract/Teste_em_pytesseract/imgs/{letras_placa}.jpg'))
        
#        path_txt = f'/media/vicrrs/Novo volume/CILIA/placas/images_plates/ann/{letras_placa}.txt'
    save_image_points = True 
    path_save_image_points = f"/home/vicrrs/Documentos/CILIA/codes/OCR/Pytesseract/Teste_em_pytesseract/imgs/{letras_placa}.jpg"
