...
def arrange_on_plate(s):
    ...
    # Ajuste as posições X e Z das letras aqui
    x_start = 0.0  # Altere o valor para ajustar a posição inicial em X
    z_offset = 0.002  # Altere o valor para ajustar a posição em Z
    ...
    for idx, char in enumerate(s):
        ...
        if original_char_obj:
            ...
            char_obj_copy.location = (x_pos, 0, z_offset)  # Ajusta a posição Z
