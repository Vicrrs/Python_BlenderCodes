...
def apply_predefined_gray_scale_to_letters(objs, gray_scale_mapping):
    """
...
def render_plate_with_gray_scale(objs, plate, letras_placa, gray_scale_mapping):
    ...
    apply_predefined_gray_scale_to_letters(objs, gray_scale_mapping)
...
if __name__ == "__main__":
    ...
    for i in range(1):
        ...
        set_plate_original_material(plate)
        ...
        apply_predefined_gray_scale_to_letters(obj_all, gray_scale_mapping)
        render_plate_with_gray_scale(obj_all, plate, letras_placa, gray_scale_mapping)  # Passando o mapeamento como argumento
